...
q、返回
    ...
    def create_school(self):
        ...
        addr = input('地址：').strip()
        if name != '' and addr != '':
            res,msg = schoolModel_obj.create_school(name,addr)
            func.echo(msg)
        else:
            func.echo('校名或地址不能为空')
    ...
    def create_class(self):
        ...
        :return:
        '''
        course_data = courseModel_obj.cat_course()
        if course_data:
        ...
        if class_name != '' and teacher_id != '' and course_id != '':
            res,msg = schoolModel_obj.create_class(class_name,course_id,teacher_id)
            func.echo(msg)
        else:
            func.echo('请添加准确的姓名')
    ...
    def create_course(self):
        ...
        if school != '' and cycle !='' and price != '' and name != '':
            ...
            res,msg = courseModel_obj.create_course(data)
            func.echo(msg)
        else:
            func.echo('课程需都添加')